...
public class PrendaController {
    ...
    @PostMapping()
    public void crearPrenda(@RequestParam String type, @RequestBody Map<String, Object> body) throws Exception {
        ...
        switch (type.toLowerCase()) {
            case "disfraz":
                ...
                if (!violations.isEmpty()) {
                    throw new IllegalArgumentException("Datos inválidos para CrearDisfrazDto");
                }
